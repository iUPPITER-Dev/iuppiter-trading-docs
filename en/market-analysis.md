...
> The exchange API uses generic MEXC spot REST endpoints. Replace `SYMBOL` with the trading pair you operate on.
...
const TARGET_PRICE = mid * 1.25  // e.g. +25%
let askUsdt = 0
...
## 5. Analysis Automation (Optional)
